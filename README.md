...
前台内容编辑入口为 http://127.0.0.1:8096/admin/content.html。它支持首页 Hero 与三项核心展项的表单编辑、公众前台实时预览、保存发布和本机草稿回退；视频与木疙瘩页面先保留接入位。英歌小槌独立入口为 http://127.0.0.1:8096/admin/assistant.html，是后台中的额外对话工作区，不替代总览、内容审核或知识评测模块。
