...
本目录将 `../knowledge-base/content/` 中面向人阅读的 Obsidian 知识库转换为智能体和 H5 可使用的产品契约。
...
1. 读取 `knowledge_manifest.json` 列出的 `knowledge-base/content/` Markdown。
2. 解析YAML，按二级/三级标题切块。
