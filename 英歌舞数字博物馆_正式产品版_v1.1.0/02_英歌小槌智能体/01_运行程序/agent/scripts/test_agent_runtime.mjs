...
const guarded = validateAgentRequest({ message: "英歌是什么？", app_id: "yingge-h5", model: "expensive-model", max_tokens: 12000, api_key: "browser-secret", base_url: "http://127.0.0.1:1" }).value;
assert.deepEqual(Object.keys(guarded).sort(), ["app_id", "history", "message"], "公众请求不得覆盖服务端模型、费用或上游地址配置");
