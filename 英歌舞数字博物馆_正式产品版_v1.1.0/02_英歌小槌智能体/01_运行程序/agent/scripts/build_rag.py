...
AGENT = Path(os.environ.get("KNOWLEDGE_GOVERNANCE_DIR", ROOT / "agent")).resolve()
KNOWLEDGE = Path(os.environ.get("KNOWLEDGE_SOURCE_DIR", ROOT / "knowledge-base" / "content")).resolve()
BUILD_OUTPUT = Path(os.environ.get("KNOWLEDGE_BUILD_OUTPUT_DIR", ROOT / "agent" / "generated")).resolve()
RUNTIME_DATA = Path(os.environ.get("KNOWLEDGE_RUNTIME_DATA_DIR", ROOT / "agent" / "runtime")).resolve()
