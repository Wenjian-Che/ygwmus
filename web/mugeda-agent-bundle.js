  ...
  function boot() {
    ...
    (function (window, document) {
      ...
      var config = {
        ...
        primaryColor: scriptConfig.primaryColor || globalConfig.primaryColor || "#b9362d",
        darkColor: scriptConfig.darkColor || globalConfig.darkColor || "#092743"
      };
      ...
      function injectStyle() {
        ...
        style.textContent = [
          ".ygw-widget{--ygw-ink:#132a3d;--ygw-navy:" + config.darkColor + ";--ygw-red:" + config.primaryColor + ";--ygw-gold:#d5a14b;position:fixed;right:22px;bottom:max(22px,env(safe-area-inset-bottom));z-index:2147483000;font-family:system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI','PingFang SC','Microsoft YaHei',sans-serif;color:var(--ygw-ink);text-align:left;line-height:1.5;box-sizing:border-box}",
          ...
          ".ygw-launch-mark{display:grid;place-items:center;width:30px;height:30px;border-radius:50%;background:linear-gradient(145deg,#da6151,var(--ygw-red));font-family:Georgia,'Songti SC',serif;font-size:18px}.ygw-panel{display:none;width:min(390px,calc(100vw - 32px));height:min(640px,calc(100dvh - 44px));margin-bottom:12px;overflow:hidden;border:1px solid #d8e0e8;border-radius:20px;background:#f7f4ee;box-shadow:0 22px 68px rgba(9,39,67,.22)}",
          ...
          ".ygw-head{display:flex;align-items:center;justify-content:space-between;padding:16px 17px;background:linear-gradient(135deg,var(--ygw-navy),#174a77);color:#fff}.ygw-head h3{margin:0;font:700 21px Georgia,'Songti SC',serif}.ygw-head p{margin:4px 0 0;color:#c6dceb;font-size:11px}.ygw-close{border:0;background:transparent;color:#c9e0f2;font-size:25px;line-height:1;cursor:pointer}.ygw-log{flex:1;overflow:auto;-webkit-overflow-scrolling:touch;padding:15px 13px 9px}.ygw-msg{display:flex;margin:0 0 13px}.ygw-msg.user{justify-content:flex-end}",
          ".ygw-bubble{max-width:90%;padding:10px 12px;border-radius:13px 13px 13px 4px;background:#fff;border:1px solid #e3e8ec;line-height:1.72;font-size:13px;overflow-wrap:anywhere}.ygw-msg.user .ygw-bubble{border:0;border-radius:13px 13px 4px 13px;background:#e9f1f7;color:#173d5d}.ygw-bubble h4{margin:9px 0 4px;color:var(--ygw-red);font-size:14px}.ygw-bubble ul{margin:6px 0;padding-left:20px}.ygw-meta{margin-top:7px;color:#82909b;font-size:10px}",
          ".ygw-citations{display:grid;gap:6px;margin-top:10px;padding-top:9px;border-top:1px solid #edf0f2}.ygw-source{display:block;padding:8px;border-radius:8px;background:#f6f8fa;color:#526978;text-decoration:none;font-size:10px;line-height:1.45}.ygw-source:hover{background:#eaf1f6}.ygw-source b{display:block;color:#274b69;font-size:11px}.ygw-quick{display:flex;gap:6px;overflow:auto;padding:0 13px 9px;scrollbar-width:none}.ygw-quick::-webkit-scrollbar{display:none}.ygw-quick button{flex:0 0 auto;border:1px solid #d5e0e8;border-radius:999px;background:#fff;color:#315876;padding:6px 9px;cursor:pointer;font-size:11px}",
          ".ygw-feedback{display:flex;align-items:center;gap:6px;margin-top:8px;padding-top:8px;border-top:1px solid #edf0f2;color:#82909b;font-size:10px}.ygw-feedback span{margin-right:auto}.ygw-feedback button{border:1px solid #d5e0e8;border-radius:999px;background:#fff;color:#315876;padding:4px 8px;cursor:pointer;font-size:10px}.ygw-feedback button:hover{border-color:var(--ygw-red);color:var(--ygw-red)}",
